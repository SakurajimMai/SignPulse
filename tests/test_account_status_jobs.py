...
@pytest.mark.asyncio
async def test_run_status_check_updates_progress_and_results(
    ...
    invalid_alerts: list[dict] = []
    monkeypatch.setattr(
        "backend.services.sign_task_notify.schedule_account_invalid_alert",
        lambda **kwargs: invalid_alerts.append(kwargs),
    )
