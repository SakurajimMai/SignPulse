...
class TestBackendLoggingConfig:
    ...
    def test_sensitive_data_filter_redacts_bot_and_proxy_credentials(self):
        from backend.main import SensitiveDataFilter

        bot_token = "123456789:ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdef"
        record = logging.LogRecord(
            ...
            msg=(
                ...
                "through socks5://alice:proxy-secret@proxy.example:1080"
            ),
            args=(bot_token,),
            exc_info=None,
        )
