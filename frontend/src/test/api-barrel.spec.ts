...
describe('api barrel 完整性', () => {
  ...
  it('settings API 导出', () => {
    ...
    expect(typeof api.getTelegramBotRuntimeStatus).toBe('function')
    expect(typeof api.testProxyConnection).toBe('function')
  ...
  it('manga E-Hentai API 导出', () => {
    expect(typeof api.startEhentaiWorker).toBe('function')
    expect(typeof api.stopEhentaiWorker).toBe('function')
  ...
  it('games API 导出', () => {
    ...
    expect(typeof api.getGamesStatus).toBe('function')
    expect(typeof api.scanGamesAutomation).toBe('function')
    expect(typeof api.retryGamesAutomation).toBe('function')
    expect(typeof api.pullGamesTelegram).toBe('function')
    expect(typeof api.publishGamesJob).toBe('function')
    expect(typeof api.listGamesCatalog).toBe('function')
    expect(typeof api.uploadGamesSource).toBe('function')
    expect(typeof api.refreshGamesClouds).toBe('function')
  })

  it('coser API 导出', () => {
    expect(typeof api.getCoserSettings).toBe('function')
    expect(typeof api.saveCoserSettings).toBe('function')
    expect(typeof api.getCoserStatus).toBe('function')
    expect(typeof api.pullCoserTelegram).toBe('function')
    expect(typeof api.publishCoserJob).toBe('function')
    expect(typeof api.listCoserCatalog).toBe('function')
    expect(typeof api.listCoserPeople).toBe('function')
    expect(typeof api.uploadCoserSource).toBe('function')
  })

  it('alerts API 导出', () => {
    expect(typeof api.getAlertRules).toBe('function')
    expect(typeof api.saveAlertRules).toBe('function')
    expect(typeof api.testAlertMail).toBe('function')
  })

  it('Mini App API 导出', () => {
    expect(typeof api.authenticateMiniApp).toBe('function')
    expect(typeof api.getMiniAppBootstrap).toBe('function')
    expect(typeof api.runMiniAppTask).toBe('function')
    expect(typeof api.getMiniAppTaskRunStatus).toBe('function')
    expect(typeof api.getMiniAppAlerts).toBe('function')
  })

  it('manga HMW API 导出', () => {
    expect(typeof api.getHmwStatus).toBe('function')
    expect(typeof api.listHmwSources).toBe('function')
    expect(typeof api.scanHmwSource).toBe('function')
    expect(typeof api.startHmwJob).toBe('function')
    expect(typeof api.resumeHmwJob).toBe('function')
    expect(typeof api.pullHmwTelegramAlbum).toBe('function')
    expect(typeof api.listHmwLibrary).toBe('function')
    expect(typeof api.getHmwLibraryManga).toBe('function')
    expect(typeof api.listHmwCatalog).toBe('function')
    expect(typeof api.syncHmwCatalog).toBe('function')
    expect(typeof api.updateHmwManga).toBe('function')
    expect(typeof api.deleteHmwManga).toBe('function')
    expect(typeof api.updateHmwChapter).toBe('function')
    expect(typeof api.deleteHmwChapter).toBe('function')
  })
