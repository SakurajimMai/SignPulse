...
export function resolveAuthRedirect(
  ...
  // Telegram Mini App exchanges signed initData for its own scoped token.
  // It must stay independent from the administrator JWT in this store.
  if (toName === 'mini-app') return undefined
