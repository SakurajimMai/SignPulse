...
| 环境 | 镜像 |
|------|------|
| 生产 | `ghcr.io/sakurajimmai/signpulse:latest` 或 `ghcr.io/sakurajimmai/signpulse:v2.2.3` |
| 稳定主干 | `ghcr.io/sakurajimmai/signpulse:main` 或 `…:main-<sha>` |
| 预发/开发 | `ghcr.io/sakurajimmai/signpulse:dev` |
